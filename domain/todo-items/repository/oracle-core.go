...
func (db *oracleTodoItemsRepository) GetAll(param map[string]interface{}) (response []valueobject.TodoItems, err error) {
...
func (db *oracleTodoItemsRepository) GetOne(param map[string]interface{}) (response valueobject.TodoItems, err error) {
	builder := database.New(ORACLE, ORACLE_TABLE, SELECT)
...
func (db *oracleTodoItemsRepository) Store(column []string, data []interface{}) (builder database.QueryConfig, err error) {
...
func (db *oracleTodoItemsRepository) Update(param map[string]interface{}, data map[string]interface{}) (builder database.QueryConfig, err error) {
...
func (db *oracleTodoItemsRepository) Delete(param map[string]interface{}) (builder database.QueryConfig, err error) {
