...
type OracleRepository interface {
	...
	GetAll(param map[string]interface{}) (response []valueobject.ActivityGroups, err error)
	GetOne(param map[string]interface{}) (response valueobject.ActivityGroups, err error)
